...
namespace xiaoLog
{
    namespace detail
    {
        ...
        // Efficient Interger to String Conversions, by Mattew Wilson.
        template <typename T>
...
LogStream &LogStream::operator<<(const void *p)
{
    ...
    constexpr static int kMaxNumericSize =
        std::numeric_limits<uintptr_t>::digits10 / 4 + 4;
    if (exBuffer_.empty())
    {
        if (buffer_.avail() >= kMaxNumericSize)
        {
...
template XIAOLOG_EXPORT Fmt::Fmt(const char *fmt, char);

template XIAOLOG_EXPORT Fmt::Fmt(const char *fmt, short);
template XIAOLOG_EXPORT Fmt::Fmt(const char *fmt, unsigned short);
template XIAOLOG_EXPORT Fmt::Fmt(const char *fmt, int);
template XIAOLOG_EXPORT Fmt::Fmt(const char *fmt, unsigned int);
template XIAOLOG_EXPORT Fmt::Fmt(const char *fmt, long);
template XIAOLOG_EXPORT Fmt::Fmt(const char *fmt, unsigned long);
template XIAOLOG_EXPORT Fmt::Fmt(const char *fmt, long long);
template XIAOLOG_EXPORT Fmt::Fmt(const char *fmt, unsigned long long);

template XIAOLOG_EXPORT Fmt::Fmt(const char *fmt, float);
template XIAOLOG_EXPORT Fmt::Fmt(const char *fmt, double);